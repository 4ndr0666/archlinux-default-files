...
set_target_properties(hidapi::hidraw PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhidapi-hidraw.so.0.13.1"
  IMPORTED_SONAME_RELEASE "libhidapi-hidraw.so.0"
  )

list(APPEND _cmake_import_check_targets hidapi::hidraw )
list(APPEND _cmake_import_check_files_for_hidapi::hidraw "${_IMPORT_PREFIX}/lib/libhidapi-hidraw.so.0.13.1" )
...
set_target_properties(hidapi::libusb PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhidapi-libusb.so.0.13.1"
  IMPORTED_SONAME_RELEASE "libhidapi-libusb.so.0"
  )

list(APPEND _cmake_import_check_targets hidapi::libusb )
list(APPEND _cmake_import_check_files_for_hidapi::libusb "${_IMPORT_PREFIX}/lib/libhidapi-libusb.so.0.13.1" )
